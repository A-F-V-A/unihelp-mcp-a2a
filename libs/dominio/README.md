...
| [`triaje.ts`](src/lib/triaje.ts)               | Clasificaciones, niveles de estado de servicio y su forma publicada (`FUERA_DE_SERVICIO`), alcance de afectacion, nivel de servicio, estados de propuesta, canales y limites de texto. |
