...
| [`resultados-2026-09-25-cuatro-arquitecturas.md`](resultados-2026-09-25-cuatro-arquitecturas.md)                     | Primera corrida con B0, B1, B2 y B3 en la misma matriz (40 tareas, gpt-5.5): efectividad, latencia descompuesta, tokens y los cuatro contrastes con sus intervalos                                                                  |
| [`resultados-2026-09-25-campana-modelos.md`](resultados-2026-09-25-campana-modelos.md)                               | Campaña de cuatro modelos (gpt-5.5, gpt-5.4, gpt-5.4-mini, gpt-4.1-mini) x cuatro arquitecturas x tres repeticiones: efectividad, latencia, tokens y contrastes por modelo; por qué el multiagente cae con modelos pequeños         |
| [`resultados-2026-09-25-campana-ollama-qwen2.5-7b.md`](resultados-2026-09-25-campana-ollama-qwen2.5-7b.md)           | El mismo experimento con el modelo local (Ollama, Qwen2.5 7B q4, decisión 46): cuatro arquitecturas x tres repeticiones, efectividad, latencia, tokens en caché y por qué el 7B no llega a hacer las llamadas que las tareas exigen |
| [`resultados-2026-09-25-campana-gemini-parcial.md`](resultados-2026-09-25-campana-gemini-parcial.md)                 | Campaña Gemini (3.8-flash, 3.5-flash, 3.1-flash-lite con `none`; 3.1-pro con `low`) interrumpida por el 402 del proveedor: qué se alcanzó (89–136 ejecuciones por modelo), qué se puede concluir y qué no, y cómo completarla       |
| [`resultados-2026-09-26-campana-gemini-flash-lite.md`](resultados-2026-09-26-campana-gemini-flash-lite.md)           | Segunda campaña Gemini, solo `gemini-3.1-flash-lite` con `none`: 348 de 480 ejecuciones antes de un nuevo 402 (40 tareas en B0/B1, 37 en B2/B3, 34 en las cuatro); efectividad, latencia, tokens, dónde falla el modelo y cómo completarla |
...
| [`modelo-local-ollama.md`](modelo-local-ollama.md)                                                                   | Cómo instalar Ollama, requisitos mínimos de la máquina, cómo conectar el modelo local a las cuatro arquitecturas, recomendaciones para la corrida y cómo leer sus cifras (decisión 46)                                              |
