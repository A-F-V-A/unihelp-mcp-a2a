...
/**
 * B3, especialista de diagnostico: el agente de su rol del nucleo multiagente
 ...
 * el agente, su prompt, su cliente MCP con `X-Agent-Id: diagnostico` y el endpoint
...
@Module({
  imports: [
    SaludModule,
    AgentCardModule,
    EspecialistaModule.forRoot({ rol: 'diagnostico', identidad: IDENTIDAD }),
  ],
})
