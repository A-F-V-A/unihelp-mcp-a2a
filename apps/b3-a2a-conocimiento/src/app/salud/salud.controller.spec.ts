...
describe('SaludController (b3-a2a-conocimiento)', () => {
  ...
  it('declara la arquitectura B3 y el servicio b3-a2a-conocimiento', () => {
    const salud = controller.consultar();

    expect(salud.estado).toBe('ok');
    expect(salud.arquitectura).toBe('B3');
    expect(salud.servicio).toBe('b3-a2a-conocimiento');
